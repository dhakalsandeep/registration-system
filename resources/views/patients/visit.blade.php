...
<div class="container">
    <div class="row">
        <form action="{{ route('patients.store_visit') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="form-group col-4 mt-2">
                <label for="hospitalno">Hospital No</label>
                <input type="text" name="hospitalno" id="hospitalno" class="form-control @error('hospitalno') is-invalid @enderror" value="{{ $hospitalNo }}" readonly>
                @error('hospitalno')
            ...
            <div class="form-group col-4 mt-2">
                ...
                <input type="file" name="profilepic" id="profilepic" class="form-control @error('profilepic') is-invalid @enderror" accept="image/*" required>
                @error('profilepic')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
